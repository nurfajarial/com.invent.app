...
if ($_POST['Submit'] == 'Submit') 
{
	...
	$cek = mysqli_query($buka, "SELECT * FROM ukuran_barang WHERE kode_ukuran='$kode_ukuran'");
	$row = mysqli_fetch_array($cek);
	if ($row['kode_ukuran'] == null )
	{
		$input1 = "INSERT INTO ukuran_barang
		(
			kode_ukuran,
			nama_ukuran,
			keterangan
	...
	else
	{
		...
		echo "<script>document.location='home.php?page=ukuran-tambah'</script>";
	}
