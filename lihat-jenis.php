    ...
    <form>
        <div id='myList' class='list-group' >
            <div class='list-group-item'>
                <h4 class='list-group-item-heading'>".$data['kode_jenis']."</h4>
                <table class='table-striped' width='100%'>
                    <tr>
                        ...
                        <td align='center' width='30%'>
                            <a href='home.php?page=jenis-ubah&&kode_jenis=".$kode_jenis."' class='btn btn-primary'>
        ...
        <div class='modal-content'>
            ...
            <div class='modal-footer'>
                <div align='center'>
                    ...
                    <a class='btn btn-primary' href='home.php?page=jenis-hapus&&kode_jenis={$kode_jenis}'>Hapus</a>
                </div>
            </div>
        </div>
    </div>
