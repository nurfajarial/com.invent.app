    ...
    <form>
        <div id='myList' class='list-group' >
            <div class='list-group-item'>
                <h4 class='list-group-item-heading'>".$data['kode_tipe']."</h4>
                <table class='table-striped' width='100%'>
                    <tr>
                        <td>
                            <span class='list-group-item-text' id='subjectName' >
                                Nama        : <b>".$data['nama_tipe']."</b><br />
                                Keterangan  : <b>".$data['keterangan']."</b><br />
                            </span>
                        </td>
                        <td align='center' width='30%'>
                            <a href='home.php?page=tipe-ubah&&kode_tipe=".$data['kode_tipe']."' class='btn btn-primary'>
        ...
        <div class='modal-content'>
            ...
            <div class='modal-footer'>
                <div align='center'>
                    ...
                    <a class='btn btn-primary' href='home.php?page=tipe-hapus&&kode_tipe={$kode_tipe}'>Hapus</a>
                </div>
            </div>
        </div>
    </div>
