    ...
    <form>
        <div id='myList' class='list-group' >
            <div class='list-group-item'>
                <h4 class='list-group-item-heading'>".$data['kode_ukuran']."</h4>
                <table class='table-striped' width='100%'>
                    <tr>
                        <td>
                            <span class='list-group-item-text' id='subjectName' >
                                Nama        : <b>".$data['nama_ukuran']."</b><br />
                                Keterangan  : <b>".$data['keterangan']."</b><br />
                            </span>
                        </td>
                        <td align='center' width='30%'>
                            <a href='home.php?page=ukuran-ubah&&kode_ukuran=".$data['kode_ukuran']."' class='btn btn-primary'>
        ...
        <div class='modal-content'>
            ...
            <div class='modal-footer'>
                <div align='center'>
                    ...
                    <a class='btn btn-primary' href='home.php?page=ukuran-hapus&&kode_ukuran={$kode_ukuran}'>Hapus</a>
                </div>
            </div>
        </div>
    </div>
