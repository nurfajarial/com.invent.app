...
if ($_POST['Submit'] == 'Submit') 
{
	...
	$nama_model = $_POST['txt_nama_model'];
	$ket = $_POST['txt_ket'];

	$cek = mysqli_query($buka, "SELECT * FROM model_barang WHERE kode_model = '$kode_model'");
	$row = mysqli_fetch_array($cek);
	if ($row['kode_model'] == null )
	{

		$input1 = "INSERT INTO model_barang
		(
			kode_model,
			nama_model,
			keterangan
	...
	else
	{
		...
		echo "<script>document.location='home.php?page=model-tambah'</script>";
	}
